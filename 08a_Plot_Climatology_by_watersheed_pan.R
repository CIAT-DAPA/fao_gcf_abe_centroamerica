...
# Set params
bDir <- "X:/1.Data/Results/climate/01_baseline/pan/atlas_1981-2022_30s"
oDir <- "X:/1.Data/Results/climate/01_baseline/pan/evaluation_v2"
...
mask <- as(project(vect("X:/1.Data/Process/Info_Inputs_SWAT/Panama/Tonosi_La_Villa/Cuencas_Drenajes/subcuencas_Tonosi_La_Villa_proj.shp"), crs_ref), "Spatial")
mask2 <- as(project(vect("X:/1.Data/Results/Salidas&Analysis_SWAT/Panama/Espacial/LineaBase/subs1.shp"), crs_ref), "Spatial")
