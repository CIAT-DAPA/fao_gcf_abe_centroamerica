...
# sspList <- c("ssp_585")
baseDir <- "X:/1.Data/Results/climate/02_climate_change/hnd_watershed_30s_anom_ens"
...
crs_ref <- crs(raster("X:/1.Data/Results/climate/02_climate_change/pan_30s_anom_ens/ssp_585/2050s/etp_1.tif"))
...
oDir <- "X:/1.Data/Results/climate/02_climate_change/hnd_evaluations_v2"
