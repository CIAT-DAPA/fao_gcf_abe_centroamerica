...
## Parameters
dDir <- "X:/1.Data/Results/climate/02_climate_change/gtm_2_5min_anom"
oDir <- "X:/1.Data/Results/climate/02_climate_change/gtm_2_5min_anom_ens"
...
for (scn in scn_list){
  ...
  gcmList <- gcmList[gcmList != "access_cm2"]   # diferente extension
  for (var in varList){
