...
oDir   <- "Z:/1.Data/Results/climate/02_climate_change/hnd_indices_v2"
tmpDir <- "Z:/1.Data/Results/climate/02_climate_change/hnd_daily"
...
maskFile <- "Z:/1.Data/Process/Info_Inputs_SWAT/Honduras/Choluteca/Division_Administrativa/Choluteca_adm3.shp"
...
adm_lookup <- data.table(
  ...
  AdmLvl1 = mask_adm1$COD_DEPTO,
  AdmLvl2 = mask_adm1$COD_MUNI,
  AdmLvl3 = mask_adm1$COD_ALDEA
)
