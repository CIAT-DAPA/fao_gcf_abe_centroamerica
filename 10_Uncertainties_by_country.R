...
ctrList <- c("CRI")
oDirU <- "D:/cenavarro/bid_mag_pasar/climate_change/uncertainties"
...
#for(ssp in sspLs){
  ...
  ## Prec
  # ssp <- sspLs[1]
  anomVals_pr_ssp <- anomVals_pr[anomVals_pr$Zone == "3", ]
  ...
  anomVals_pr_sts <- data.frame(cbind(rbind(cbind(SEASON="DEF", PERIOD=anomVals_pr_avg$Period, ZONE=anomVals_pr_avg$Zone, MEAN=anomVals_pr_avg$djf, SSP=anomVals_pr_avg$ssp), 
                                            cbind(SEASON="MAM", PERIOD=anomVals_pr_avg$Period, ZONE=anomVals_pr_avg$Zone, MEAN=anomVals_pr_avg$mam, SSP=anomVals_pr_avg$ssp),
                                            cbind(SEASON="JJA", PERIOD=anomVals_pr_avg$Period, ZONE=anomVals_pr_avg$Zone, MEAN=anomVals_pr_avg$jja, SSP=anomVals_pr_avg$ssp),
                                            cbind(SEASON="SON", PERIOD=anomVals_pr_avg$Period, ZONE=anomVals_pr_avg$Zone, MEAN=anomVals_pr_avg$son, SSP=anomVals_pr_avg$ssp),
                                            cbind(SEASON="ANN", PERIOD=anomVals_pr_avg$Period, ZONE=anomVals_pr_avg$Zone, MEAN=anomVals_pr_avg$ann, SSP=anomVals_pr_avg$ssp)),
  ...
  anomVals_pr_sts[anomVals_pr_sts=="ssp_126"]<- "SSP 1-2.6"
  anomVals_pr_sts[anomVals_pr_sts=="ssp_245"]<- "SSP 2-4.5"
  anomVals_pr_sts[anomVals_pr_sts=="ssp_585"]<- "SSP 5-8.5"
  
  PlotP <- paste0(oDirU, "/uncertainties_prec.tif")
  ...
  p <- ggplot() +
    ...
    ylim(-40, 20) + 
    facet_grid( SSP ~ factor(SEASON, levels=c('DEF', 'MAM', 'JJA', 'SON', 'ANN'))) +
    labs(x="Periodos ", y="Anomalia (%)")
  
  tiff(PlotP, width=1200, height=700, pointsize=8, compression='lzw',res=150)
  plot(p)
  dev.off()
  ...
  ## Tmean
  # ssp <- sspLs[1]
  anomVals_tm_ssp <- anomVals_tm[anomVals_tm$Zone == "3", ]
  ...
  anomVals_tm_sts <- data.frame(cbind(rbind(cbind(SEASON="DEF", PERIOD=anomVals_tm_avg$Period, ZONE=anomVals_tm_avg$Zone, MEAN=anomVals_tm_avg$djf, SSP=anomVals_pr_avg$ssp), 
                                            cbind(SEASON="MAM", PERIOD=anomVals_tm_avg$Period, ZONE=anomVals_tm_avg$Zone, MEAN=anomVals_tm_avg$mam, SSP=anomVals_pr_avg$ssp),
                                            cbind(SEASON="JJA", PERIOD=anomVals_tm_avg$Period, ZONE=anomVals_tm_avg$Zone, MEAN=anomVals_tm_avg$jja, SSP=anomVals_pr_avg$ssp),
                                            cbind(SEASON="SON", PERIOD=anomVals_tm_avg$Period, ZONE=anomVals_tm_avg$Zone, MEAN=anomVals_tm_avg$son, SSP=anomVals_pr_avg$ssp),
                                            cbind(SEASON="ANN", PERIOD=anomVals_tm_avg$Period, ZONE=anomVals_tm_avg$Zone, MEAN=anomVals_tm_avg$ann, SSP=anomVals_pr_avg$ssp)),
  ...
  anomVals_tm_sts[anomVals_tm_sts=="ssp_126"]<- "SSP 1-2.6"
  anomVals_tm_sts[anomVals_tm_sts=="ssp_245"]<- "SSP 2-4.5"
  anomVals_tm_sts[anomVals_tm_sts=="ssp_585"]<- "SSP 5-8.5"
  
  PlotP <- paste0(oDirU, "/uncertainties_tmean.tif")
