...
# Set params
bDir <- "X:/1.Data/Results/climate/01_baseline/gtm/wcl_v21_2_5min"
oDir <- "X:/1.Data/Results/climate/01_baseline/gtm/evaluation"
varList <- c("prec", "tmax", "tmin", "tmean")
id <- c("Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic")
maskFile <- "X:/1.Data/Results/climate/00_admin_data/gtm/cuenca_salinas_gtm_mun.shp"
...
for (var in varList){
  ...
  if (var == "prec"){
    ...
    zvalues <- seq(0, 3500, 100) # Define limits
    myTheme <- BuRdTheme() # Define squeme of colors
